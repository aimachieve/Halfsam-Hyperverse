...
import HalfsamFactoryABI from '../artifacts/contracts/HalfsamFactory.sol/HalfsamFactory.json';
import HalfsamABI from '../artifacts/contracts/Halfsam.sol/Halfsam.json';

export const FactoryABI = HalfsamFactoryABI.abi as ContractInterface;
export const ContractABI = HalfsamABI.abi as ContractInterface;
