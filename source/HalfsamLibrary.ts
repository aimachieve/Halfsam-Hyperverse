...
export type HalfsamLibraryType = Awaited<ReturnType<typeof HalfsamLibraryInternal>>;
export function HalfsamLibrary(
	...args: Parameters<typeof HalfsamLibraryInternal>
): CancellablePromise<HalfsamLibraryType> {
	return pseudoCancellable(HalfsamLibraryInternal(...args));
}

export async function HalfsamLibraryInternal(
